...
app.layout = html.Div([
    ...
    html.Div(
    children=[
        html.Div( # Div del grafo de números
            children=[
        ...
        html.Div( # Div de la tabla de los nombres
            children=[
        ...
        html.Div( # Div contenedor de las figuras
            children=[
...
def grafo(n_clicks_list, button_ids_list):
    if any(n_clicks_list):
        ...
        return cytoscape_graph,graph_component, tabla
    else:
